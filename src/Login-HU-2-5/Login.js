        ...
        <div className='contenedor-login'>
            <div className='contenedor-login-login'>
                ...
                <div>
                    ...
                    <label>Email</label>
                    <input type="text" className="inputLogin" placeholder='Ingrese su Email'></input><p></p>
                    <label>Contraseña</label>
                    <input type="text" className="inputLogin" placeholder='Ingrese su Contraseña'></input><p></p>
                    <button className='botonConfirmar'>Confirmar</button><p></p>
                    <p>¿No tenes una cuenta? <a href='https://www.minecraft.net/es-es/login'>Crear</a></p>
                    <p>-O-</p>
